...
# Suggested by - @d0n0t (https://github.com/code-rgb/KannaX/issues/9)
...
from kannax.utils import post_to_telegraph, runcmd, safe_filename


@kannax.on_cmd("mediainfo", about={"header": "Get Detailed Info About Replied Media"})
