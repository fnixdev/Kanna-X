...
PATH = "./kannax/xcache/spoiler_db.json"
...
if kannax.has_bot:
    ...
    @kannax.bot.on_callback_query(filters.regex(pattern=r"^getl([\S]+)$"))
    ...
    @kannax.bot.on_callback_query(filters.regex(pattern=r"^nobtnspoiler([\S]+)$"))
