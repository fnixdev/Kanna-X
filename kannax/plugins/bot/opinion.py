...
PATH = "kannax/xcache/emoji_data.txt"
CHANNEL = kannax.getCLogger(__name__)


if kannax.has_bot:

    @kannax.bot.on_callback_query(filters.regex(pattern=r"^op_(y|n)_(\d+)$"))
    ...
    @kannax.bot.on_callback_query(filters.regex(pattern=r"^opresult_(\d+)$"))
